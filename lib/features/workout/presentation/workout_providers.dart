...
final sessionForDateProvider = StreamProvider.family<WorkoutSessionModel?, DateTime>(
  (ref, date) {
...
final entriesForDateProvider = FutureProvider.family<List<ExerciseEntryModel>, DateTime>(
  (ref, date) async {
